...
from .serializers import CountySerializer, CountyBorderSerializer, VotingPrecinctSerializer, CountyPopulationSerializer
...
class CountyPopulationDetail(generics.RetrieveAPIView):
	"""
	...
	queryset = CountyPopulation.objects.all()
	serializer_class = CountyPopulationSerializer
	lookup_field = 'county'